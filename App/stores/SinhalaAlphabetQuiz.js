...
import SinhalaAlphabetData from './alphabetData/SinhalaAlphabetData';
import MaterialCommunityIcons from 'react-native-vector-icons/MaterialCommunityIcons';

const SinhalaAlphabetQuiz = ({ navigation }) => {
  const allQuestions = SinhalaAlphabetData;
...
export default SinhalaAlphabetQuiz;
