...
import SinhalaColorsData from './colorsData/SinhalaColorsData';
import MaterialCommunityIcons from 'react-native-vector-icons/MaterialCommunityIcons';

const SinhalaColorsQuiz = ({ navigation }) => {
  const allQuestions = SinhalaColorsData;
  ...
  return (
    <ImageBackground
      ...
      <View style={styles.footer}>
        <TouchableOpacity
          onPress={() => navigation.navigate('SinhalaColorsScreen')}
          style={styles.button}>
...
export default SinhalaColorsQuiz;
