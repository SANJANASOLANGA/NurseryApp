...
import SinhalaPhrasesData from './phrasesData/SinhalaPhrasesData';
import MaterialCommunityIcons from 'react-native-vector-icons/MaterialCommunityIcons';

const SinhalaPhrasesQuiz = ({ navigation }) => {
  const allQuestions = SinhalaPhrasesData;
...
export default SinhalaPhrasesQuiz;
