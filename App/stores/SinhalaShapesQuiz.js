...
import SinhalaShapesData from './shapesData/SinhalaShapesData';
import MaterialCommunityIcons from 'react-native-vector-icons/MaterialCommunityIcons';

const SinhalaShapesQuiz = ({ navigation }) => {
  const allQuestions = SinhalaShapesData;
  ...
  return (
    <ImageBackground
      ...
      <View style={styles.footer}>
        <TouchableOpacity
          onPress={() => navigation.navigate('SinhalaShapesScreen')}
          style={styles.button}>
...
export default SinhalaShapesQuiz;
